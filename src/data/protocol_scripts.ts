...
O seu encontro com você.`,
  ...
  ATERRAMENTO: {
    ...
    subtitle: '',
    fullText: `Agora começamos encontrando chão. Antes de seguirmos para qualquer outro lugar, permita que o seu corpo perceba que pode repousar. Há algo muito simples e profundo em sentir-se sustentado. Por alguns instantes, não precisamos resolver nada. Vamos apenas chegar por inteiro neste momento.
...
Para encerrar, selar e proteger este tratamento, ativo o Empoderamento de Ganesha.
