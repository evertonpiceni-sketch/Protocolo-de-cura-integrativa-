      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mb-6 print:hidden">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-medium flex items-center gap-2 transition cursor-pointer ${
              activeTab === 'report'
                ? 'bg-[#B88736]/20 border border-[#B88736]/50 text-[#B88736] shadow'
                : 'text-[#5C5248] hover:text-[#2A2420]'
            }`}
          >
            <FileText size={15} />
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="space-y-3 relative z-10">
                ...
                <h1 className="text-2xl md:text-3xl font-serif text-[#2A2420] font-bold tracking-wide">
                  Protocolo de Cura Integrada
                </h1>

                <p className="text-xs text-[#5C5248] max-w-lg mx-auto">
                ...
                <p className="text-xs text-[#5C5248] max-w-xl mx-auto leading-relaxed pt-1">
                ...
                <div className="grid grid-cols-2 gap-4 pt-6 max-w-md mx-auto text-left border-t border-[#E5DAC6]">
                  <div>
                    <span className="text-[9px] font-mono text-[#85786C] uppercase block">Canalização e Direção</span>
                    <strong className="text-xs text-[#2A2420] block">Éverton Rodrigo Piceni</strong>
                    <span className="text-[10px] text-amber-400/90 font-serif italic">Terapeuta Quântico & Integrativo</span>
                  </div>
                  <div className="text-right">
                    <span className="text-[9px] font-mono text-[#85786C] uppercase block">Data e Código</span>
                    <strong className="text-xs text-[#2A2420] block">{issueDate}</strong>
                    <span className="text-[9px] font-mono text-[#5C5248]">{authCode}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-2xl bg-white border border-[#E5DAC6] space-y-4">
              <div className="flex items-center justify-between border-b border-[#E5DAC6] pb-3">
                <div>
                  <h3 className="text-sm font-semibold text-[#2A2420]">Mapa Vibracional dos 21 Dias</h3>
                  <p className="text-xs text-[#5C5248]">Análise de constância e estado emocional consolidado</p>
                </div>
                <div className="px-3 py-1 bg-[#B88736]/10 border border-[#B88736]/30 rounded-lg text-[#B88736] text-xs font-mono">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="p-3 rounded-xl bg-[#FBF8F2] border border-[#E5DAC6] text-center">
                  <span className="text-[10px] font-mono text-[#5C5248] uppercase block">Frequência de Paz</span>
                  <span className="text-xl font-bold text-emerald-400 mt-1 block">
                    {averageMood > 0 ? (averageMood * 20).toFixed(0) + '%' : '100%'}
                  </span>
                </div>
                <div className="p-3 rounded-xl bg-[#FBF8F2] border border-[#E5DAC6] text-center">
                  <span className="text-[10px] font-mono text-[#5C5248] uppercase block">Sequência Atual</span>
                  <span className="text-xl font-bold text-amber-400 mt-1 block">
                    {userProfile.currentStreak || 0} dias
                  </span>
                </div>
                <div className="p-3 rounded-xl bg-[#FBF8F2] border border-[#E5DAC6] text-center">
                  <span className="text-[10px] font-mono text-[#5C5248] uppercase block">Transmutações</span>
                  <span className="text-xl font-bold text-[#B88736] mt-1 block">
                    ...
                    progress
                      ...
                      .map(p => (
                        <div key={p.dayNumber} className="p-2.5 rounded-xl bg-[#FBF8F2]/90 border border-[#E5DAC6] text-xs">
                          ...
                          <p className="text-[#5C5248] italic">"{p.journalText}"</p>
                        </div>
                      ))
                  ) : (
                    <div className="p-4 rounded-xl bg-[#FBF8F2]/40 text-center text-xs text-[#85786C]">
