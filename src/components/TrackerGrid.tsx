  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-3 sm:px-4 py-4 sm:py-6 flex flex-col items-center justify-center space-y-6 sm:space-y-8" id="tracker-dashboard">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-850 to-indigo-950 rounded-3xl p-5 sm:p-6 md:p-8 border border-[#B88736]/30 shadow-2xl relative overflow-hidden space-y-6" id="tracker-hero">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start relative z-10">
          ...
          <div className="lg:col-span-7 space-y-4 text-center sm:text-left">
            ...
            {anamnesis ? (
              <div className="p-4 sm:p-5 rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-950/40 to-purple-950/40 border-2 border-[#B88736]/60 shadow-2xl space-y-4 text-left">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#B88736]/20 pb-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-2xl bg-[#B88736]/20 text-[#B88736] border border-[#B88736]/40 flex items-center justify-center shadow-inner shrink-0">
                      <Volume2 size={20} className={isPlayingTherapeuticVoice ? "animate-pulse text-[#B88736]" : ""} />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-1.5 p-1 bg-white/80 rounded-xl border border-[#E5DAC6] self-start sm:self-auto shrink-0">
                    <button
                      type="button"
                      onClick={() => {
                ...
                {/* Player Controls */}
                <div className="p-3 sm:p-4 rounded-2xl bg-white/80 border border-[#E5DAC6]">
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <div className="flex-1 overflow-hidden">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-[#2A2420] truncate">
                          {isLoadingVoice
                            ? "Sintetizando áudio..."
                            : isPlayingTherapeuticVoice
              ...
              <div className="p-3.5 sm:p-4 rounded-2xl bg-white/75 border border-[#B88736]/20 space-y-2.5 text-center sm:text-left">
                <p className="text-xs md:text-sm text-[#5C5248] leading-relaxed font-sans">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-2 pt-2 border-t border-[#E5DAC6]">
                  <span className="text-xs text-[#5C5248] font-sans">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3.5 mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-[#E5DAC6]/40" id="stats-panel">
          <div className="flex items-center gap-2.5 sm:gap-3 p-2.5 sm:p-3 rounded-2xl bg-white/70 border border-[#E5DAC6]">
            ...
            <div className="truncate min-w-0">
              <p className="text-[10px] text-[#85786C] font-mono uppercase tracking-wider truncate">Streak Atual</p>
              <p className="text-sm sm:text-base md:text-lg font-display font-bold text-[#2A2420] truncate">{streak} {streak === 1 ? 'Dia' : 'Dias'}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 p-2.5 sm:p-3 rounded-2xl bg-white/70 border border-[#E5DAC6]">
            ...
            <div className="truncate min-w-0">
              <p className="text-[10px] text-[#85786C] font-mono uppercase tracking-wider truncate">Recorde</p>
              <p className="text-sm sm:text-base md:text-lg font-display font-bold text-[#2A2420] truncate">{longestStreak} {longestStreak === 1 ? 'Dia' : 'Dias'}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 p-2.5 sm:p-3 rounded-2xl bg-white/70 border border-[#E5DAC6]">
            ...
            <div className="truncate min-w-0">
              <p className="text-[10px] text-[#85786C] font-mono uppercase tracking-wider truncate">Concluído</p>
              <p className="text-sm sm:text-base md:text-lg font-display font-bold text-[#2A2420] truncate">{completedDaysCount} / {totalDays}</p>
            </div>
          </div>

          <div className="flex items-center gap-2.5 sm:gap-3 p-2.5 sm:p-3 rounded-2xl bg-white/70 border border-[#E5DAC6]">
            <div className="w-10 h-10 sm:w-11 sm:h-11 bg-[#B88736]/10 border border-[#B88736]/20 text-[#B88736] rounded-xl flex items-center justify-center shrink-0">
              <Heart size={18} />
            </div>
            <div className="truncate min-w-0">
              <p className="text-[10px] text-[#85786C] font-mono uppercase tracking-wider truncate">Progresso</p>
              <p className="text-sm sm:text-base md:text-lg font-display font-bold text-[#2A2420] truncate">{completionPercent}%</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-start sm:items-center gap-3">
            ...
            <div>
              ...
              <h3 className="text-sm md:text-base font-semibold text-[#2A2420]">
                {anamnesisRecommendation
              ...
              <p className="text-xs text-[#5C5248] mt-0.5 max-w-xl">
                {anamnesisRecommendation
          ...
          <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto">
            <button
              ...
              className={`flex-1 sm:flex-initial px-4 py-2.5 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition cursor-pointer ${
                anamnesis
                  ? 'bg-[#F5EFE4] hover:bg-slate-700 text-[#2A2420] border border-[#E5DAC6]'
      ...
      <div className="p-5 rounded-3xl border bg-gradient-to-r from-purple-950/40 via-[#FBF8F2] to-indigo-950/40 border-purple-500/35 shadow-lg relative overflow-hidden" id="tracker-astral-map-card">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-start sm:items-center gap-3.5">
            <div className="p-3 rounded-2xl shrink-0 bg-purple-500/20 text-[#B88736] border border-purple-500/30 shadow-md shadow-purple-500/10 flex items-center justify-center">
              <Compass size={22} className="text-amber-400 shrink-0" />
            </div>
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <span className="text-[10px] font-mono uppercase tracking-widest text-[#B88736] font-bold flex items-center gap-1">
                ...
                {astralMap && (
                  <span className="px-2 py-0.5 rounded-full bg-[#B88736]/20 text-[#B88736] text-[10px] font-mono border border-[#B88736]/30">
                    Ascendente em {astralMap.ascendantSign}
                  </span>
                )}
              </div>
              <h3 className="text-sm md:text-base font-semibold text-[#2A2420] mt-1">
                {astralMap
              ...
              <p className="text-xs text-[#5C5248] mt-0.5 max-w-xl leading-relaxed">
                {astralMap
      ...
      <div className="p-5 rounded-3xl border bg-gradient-to-r from-emerald-950/40 via-[#FBF8F2] to-teal-950/30 border-emerald-500/40 shadow-lg relative overflow-hidden" id="tracker-specific-treatment-card">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-start sm:items-center gap-3.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4" id="tracker-numerology-baths-grid">
        ...
        <div className="p-5 rounded-3xl border bg-gradient-to-br from-indigo-950/40 via-[#FBF8F2] to-purple-950/30 border-[#B88736]/40 shadow-lg flex flex-col justify-between space-y-4" id="card-numerology-promo">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono text-[#B88736] font-bold">1 a 9 • 11 • 22</span>
            </div>

            <h3 className="text-sm md:text-base font-display font-medium text-[#2A2420] flex items-center gap-2">
        ...
        <div className="p-5 rounded-3xl border bg-gradient-to-br from-emerald-950/40 via-[#FBF8F2] to-teal-950/30 border-emerald-500/40 shadow-lg flex flex-col justify-between space-y-4" id="card-herbal-baths-promo">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3.5 p-3.5 sm:p-4 bg-[#FBF8F2]/90 border border-[#E5DAC6] rounded-3xl shadow-lg" id="journey-switcher-container">
        <div className="flex items-center gap-3 px-1 text-center sm:text-left">
          ...
          <div>
            <span className="text-xs font-mono font-bold text-[#2A2420] uppercase tracking-wider block">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4" id="tracker-spiritual-offerings-grid">
        ...
        <div className="p-5 rounded-3xl border bg-gradient-to-br from-blue-950/40 via-[#FBF8F2] to-indigo-950/30 border-blue-500/40 shadow-lg flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
        ...
        <div className="p-5 rounded-3xl border bg-gradient-to-br from-teal-950/40 via-[#FBF8F2] to-emerald-950/30 border-teal-500/40 shadow-lg flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
        ...
        <div className="p-5 rounded-3xl border bg-gradient-to-br from-violet-950/40 via-[#FBF8F2] to-fuchsia-950/30 border-violet-500/40 shadow-lg flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
        ...
        <div className="p-5 rounded-3xl border bg-gradient-to-br from-purple-950/40 via-[#FBF8F2] to-amber-950/30 border-purple-500/40 shadow-lg flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4" id="therapeutic-trio-grid">
        ...
        <div className="p-5 rounded-3xl border bg-gradient-to-br from-amber-950/30 via-[#FBF8F2] to-amber-950/10 border-amber-500/35 shadow-lg flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-mono uppercase tracking-widest text-amber-400 font-bold bg-amber-500/10 border border-amber-500/30 px-2.5 py-0.5 rounded-full flex items-center gap-1">
        ...
        <div className="p-5 rounded-3xl border bg-gradient-to-br from-emerald-950/30 via-[#FBF8F2] to-teal-950/20 border-emerald-500/35 shadow-lg flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-mono uppercase tracking-widest text-emerald-400 font-bold bg-emerald-500/10 border border-emerald-500/30 px-2.5 py-0.5 rounded-full flex items-center gap-1">
        ...
        <div className="p-5 rounded-3xl border bg-gradient-to-br from-indigo-950/30 via-[#FBF8F2] to-purple-950/20 border-[#B88736]/35 shadow-lg flex flex-col justify-between space-y-4">
          ...
          <button
            ...
            className="w-full py-2.5 rounded-xl bg-[#B88736] hover:bg-[#B88736] text-white font-bold text-xs flex items-center justify-center gap-2 transition cursor-pointer shadow-md shadow-indigo-600/20"
          >
      ...
      {(() => {
        ...
        return (
          <div className="p-5 rounded-3xl border bg-gradient-to-r from-indigo-950/40 via-purple-950/20 to-slate-900 border-[#B88736]/30 shadow-lg relative overflow-hidden" id="tracker-daily-quote-card">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-1 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded-full bg-[#B88736]/10 text-[#B88736] text-[10px] font-mono border border-[#B88736]/20">
                    {todayInsight?.title || 'Harmonia & Paz'}
                  </span>
                </div>
                <p className="text-sm md:text-base text-[#2A2420] italic font-serif leading-relaxed">
                  "{todayInsight?.quote || 'O silêncio interior é a porta de entrada para a autocura.'}"
                </p>
                <p className="text-xs text-[#B88736]/80 font-mono font-medium pt-0.5">
            ...
            {/* Grid Header */}
      <div className="flex items-center justify-between border-b border-[#E5DAC6] pb-3" id="grid-header-section">
        <h2 className="text-lg font-display font-medium text-[#5C5248] flex items-center gap-2">
          <Calendar size={18} className="text-[#B88736] shrink-0" />
          <span>{activeJourney === '7d' ? 'Alinhamento dos 7 Chakras' : 'Calendário de Alinhamento (21 Dias)'}</span>
        </h2>
        <span className="text-xs text-[#85786C] font-mono hidden sm:inline">
      ...
      <div className="space-y-8" id="calendar-days-grid">
        {(() => {
              ...
              <div className={`p-4 rounded-2xl border ${bgClass.replace('20', '10')} ${borderClass} relative overflow-hidden group`}>
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-sm md:text-base font-bold text-[#2A2420]">{title}</h3>
                  </div>
                  <p className="text-[11px] sm:text-xs text-[#5C5248] mb-3 leading-relaxed max-w-2xl">
                    {description}
                  </p>
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#FBF8F2]/75 border border-[#E5DAC6]/50 text-[10px] sm:text-[11px] font-medium text-[#5C5248]">
                    <Compass size={12} className="text-[#5C5248]" />
              ...
              <div className={`grid gap-3 grid-cols-2 sm:grid-cols-4 md:grid-cols-7`}>
                {Array.from({ length: endDay - startDay + 1 }, (_, index) => {
                  ...
                  if (status === 'completed') {
                    ...
                    cardClass = "bg-white/80 border-amber-500/20 text-[#85786C] hover:border-amber-500/40 hover:text-[#5C5248]";
                    iconElement = <Lock size={14} className="text-amber-400/80" />;
                  } else {
                    cardClass = "bg-white/40 border-[#E5DAC6] text-[#85786C] cursor-not-allowed opacity-60";
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-2">
                        <p className="text-[10px] sm:text-[11px] font-sans font-medium line-clamp-2 leading-snug group-hover:text-[#2A2420]">
            ...
            return (
              <>
                {renderCycle(1, 7, "Ciclo 1: Proteção & Limpeza (São Miguel)", "Nesta fase inicial, o foco é a remoção de amarras, proteção espiritual e limpeza de energias densas, preparando seu campo para a cura profunda.", "Limpeza Profunda e Aterramento", <Shield size={16} className="text-[#B88736]" />, "bg-[#B88736]/20", "border-[#B88736]/20")}
...
const CustomTooltip = ({ active, payload }: any) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-white border border-[#E5DAC6] p-4 rounded-xl shadow-2xl max-w-xs space-y-2">
        <div className="flex items-center justify-between border-b border-[#E5DAC6] pb-1.5">
          <span className="text-xs font-mono text-[#B88736] font-semibold uppercase">Dia {data.dayNumber}</span>
          <span className="text-xs font-mono text-[#85786C]">{data.completed ? 'Concluído' : 'Pendente'}</span>
        </div>
        <div className="space-y-1">
          <p className="text-xs font-display font-medium text-[#2A2420]">{data.focusTitle}</p>
          <div className="flex items-center gap-1.5 text-[11px]">
            <span className="text-[#5C5248] font-sans">Estado:</span>
            <span className="text-[#2A2420] font-medium font-sans">{getMoodName(data.mood)}</span>
          </div>
        </div>
        {data.journalText && (
          <div className="pt-1.5 border-t border-[#E5DAC6]">
            <span className="text-[9px] font-mono text-[#85786C] uppercase block">Nota do Diário:</span>
            <p className="text-[10px] text-[#5C5248] italic line-clamp-2 leading-relaxed font-sans">
              "{data.journalText}"
            </p>
          </div>
        )}
