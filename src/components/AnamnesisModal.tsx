      ...
      >
        ...
        {!isEditing && existingAnamnesis ? (
            ...
            <div className="p-5 md:p-6 rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-950/40 to-purple-950/40 border-2 border-[#B88736]/60 shadow-2xl space-y-5" id="anamnesis-audio-player-card">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#B88736]/20 pb-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-2xl bg-[#B88736]/20 text-[#B88736] border border-[#B88736]/40 flex items-center justify-center shadow-inner">
                ...
                <div className="flex items-center gap-1.5 p-1 bg-white/80 rounded-xl border border-[#E5DAC6] self-start sm:self-auto">
                  <button
                    type="button"
                    onClick={() => {
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[11px] text-[#5C5248] line-clamp-1 mt-0.5">
              ...
              {/* Feedback Form / Area */}
              <div className="p-4 rounded-2xl bg-white/75 border border-[#E5DAC6] space-y-3" id="anamnesis-feedback-area">
                <div className="flex items-center justify-between">
                  <label className="text-xs font-semibold text-[#2A2420] flex items-center gap-1.5">
                    <MessageSquare size={14} className="text-[#B88736]" />
                    <span>Como você se sente ao ouvir este acolhimento?</span>
                  </label>
                  <span className="text-[10px] text-[#5C5248]">Feedback do Consulente</span>
                </div>
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl text-xs font-medium border flex items-center justify-center gap-1.5 transition cursor-pointer ${
                        feedbackReaction === r.id
                          ? 'bg-[#B88736] text-white border-[#B88736] shadow-md'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl text-xs font-semibold flex items-center gap-1.5 transition cursor-pointer border-none ${
                        feedbackReaction || feedbackComment.trim()
                          ...
                          : 'bg-[#F5EFE4] text-[#85786C] cursor-not-allowed'
                      }`}
                    >
                      <Send size={12} />
            ...
            {recommendation && (
              <div className="p-5 rounded-2xl bg-gradient-to-br from-amber-950/30 via-[#FBF8F2] to-indigo-950/40 border-2 border-amber-500/40 space-y-4 shadow-2xl relative overflow-hidden" id="anamnesis-recommended-treatment">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 border-b border-amber-500/20 pb-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <h3 className="text-base font-semibold text-[#2A2420] mt-0.5">
                        {recommendation.treatmentTitle}
                      </h3>
                    </div>
                  </div>

                  <span className="text-xs font-mono text-[#B88736] bg-[#B88736]/20 border border-[#B88736]/30 px-3 py-1 rounded-xl shrink-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                  <div className="p-3 rounded-xl bg-white/70 border border-[#E5DAC6] space-y-1">
                    ...
                    <p className="text-xs text-[#2A2420] font-medium">{recommendation.primaryChakraFocus}</p>
                  </div>
                  <div className="p-3 rounded-xl bg-white/70 border border-[#E5DAC6] space-y-1">
                    <span className="text-[10px] font-mono uppercase text-[#B88736] font-bold flex items-center gap-1">
                      <Activity size={11} className="text-[#B88736]" />
                ...
                {recommendation.prescribedReikis && recommendation.prescribedReikis.length > 0 && (
                  <div className="space-y-3 bg-gradient-to-br from-indigo-950/50 via-purple-950/30 to-[#F3EBDD] p-4 rounded-2xl border border-[#B88736]/30 shadow-lg">
                    ...
                    {recommendation.prescribedReikis[0] && (
                      <div className="p-3.5 rounded-xl bg-white/90 border border-amber-500/30 space-y-1.5">
                      ...
                      <div className="space-y-1.5 pt-1">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          {recommendation.prescribedReikis.slice(1).map((rk, idx) => (
                            <div key={idx} className="p-2.5 rounded-xl bg-[#FBF8F2]/85 border border-[#E5DAC6] text-[11px] space-y-1">
                              <div className="flex items-center justify-between gap-1">
                                <strong className="text-[#2A2420] font-semibold text-xs">{rk.name}</strong>
                                <span className="text-[9px] font-mono text-[#B88736] bg-[#B88736]/20 border border-[#B88736]/30 px-1.5 py-0.2 rounded font-semibold shrink-0">
                                  {rk.badge}
                                </span>
                              </div>
                              <p className="text-[#5C5248] text-[10px] leading-relaxed">
                                {rk.description}
                              </p>
                            </div>
                          ))}
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      ...
                      <>
                        {recommendation.recommendedFloral && (
                          <div className="p-2.5 rounded-xl bg-white/65 border border-[#E5DAC6] text-[11px] space-y-0.5">
                            ...
                            <p className="text-[#5C5248] font-medium text-[10px] leading-tight mt-1">{recommendation.recommendedFloral}</p>
                          </div>
                        )}
                        {recommendation.recommendedAromatherapy && (
                          <div className="p-2.5 rounded-xl bg-white/65 border border-[#E5DAC6] text-[11px] space-y-0.5">
                            ...
                            <p className="text-[#5C5248] font-medium text-[10px] leading-tight mt-1">{recommendation.recommendedAromatherapy}</p>
                          </div>
                        )}
                      </>
                    ) : (
                    ...
                    {recommendation.complementaryPractices.slice(0, 2).map((prac, idx) => (
                      <div key={idx} className="p-2.5 rounded-xl bg-white/65 border border-[#E5DAC6] text-[11px] space-y-0.5">
                        <div className="flex items-center justify-between">
                          <strong className="text-[#2A2420]">{prac.title}</strong>
                          <span className="text-[9px] font-mono text-[#B88736] bg-[#B88736]/10 px-1.5 py-0.5 rounded">
                            {prac.badge}
                          </span>
                        </div>
                        <p className="text-[#5C5248] text-[10px] leading-tight">{prac.description}</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-[#E5DAC6] print:hidden">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="px-5 py-2 rounded-xl bg-[#B88736] hover:bg-[#B88736] text-white text-xs font-medium flex items-center gap-1.5 transition cursor-pointer shadow-lg shadow-indigo-600/10"
                >
                  <Check size={14} />
                  <span>Concluir</span>
                </button>
          ...
          <div className="space-y-6">
            ...
            {/* Progress Bar */}
            <div className="w-full h-1.5 bg-[#F5EFE4] rounded-full overflow-hidden">
              <div
            ...
            {currentStep === 1 && (
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {COMPLAINTS_OPTIONS.map((item) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`p-2 rounded-xl shrink-0 ${isSelected ? 'bg-[#B88736]/20 text-[#B88736]' : 'bg-[#FBF8F2] text-[#85786C]'}`}>
                          <Icon size={16} />
                        </div>
                        <span className="text-xs font-medium flex-1">{item.label}</span>
                        {isSelected && <Check size={14} className="text-[#B88736]" />}
                      </button>
                    );
                  })}
                </div>
                ...
                <div className="space-y-1.5 pt-2">
                  <label className="text-[11px] font-mono text-[#5C5248] uppercase">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-[#E5DAC6] rounded-xl p-3 text-xs text-[#2A2420] placeholder-slate-600 outline-none focus:border-[#B88736] resize-none"
                  />
                </div>
              </div>
            )}
            ...
            {currentStep === 2 && (
              <div className="space-y-5">
                {/* Stress Slider */}
                <div className="p-4 bg-white border border-[#E5DAC6] rounded-2xl space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-mono text-[#5C5248] uppercase text-[10px]">
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-[#FBF8F2] rounded-lg appearance-none cursor-pointer accent-indigo-500 focus:outline-none"
                  />
                  <div className="flex justify-between text-[10px] text-[#85786C] font-mono">
                ...
                {/* Sleep Quality */}
                <div className="space-y-1.5">
                  <label className="text-[11px] font-mono text-[#5C5248] uppercase">Qualidade do seu Sono</label>
                    ...
                    return (
                      ...
                      >
                        <div className={`w-5 h-5 rounded-full border flex items-center justify-center shrink-0 mt-0.5 ${
                          isSel ? 'border-current bg-current/20' : 'border-[#E5DAC6]'
                        }`}>
                          {isSel && <Check size={12} className="text-current" />}
                        </div>
                        <div className="flex-1">
                          <h4 className="text-xs font-semibold text-[#2A2420]">{chakra.name}</h4>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      >
                        <span>{g}</span>
                        {primaryGoal === g && <Check size={14} className="text-[#B88736]" />}
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-1.5 pt-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      >
                        <strong className="text-xs block text-[#2A2420]">{t.label}</strong>
                        <span className="text-[10px] text-[#85786C]">{t.desc}</span>
                      </button>
                    ))}
                  </div>
                </div>
            ...
            {/* Navigation Buttons */}
            <div className="flex items-center justify-between pt-4 border-t border-[#E5DAC6]">
              {currentStep > 1 ? (
                <button
                  type="button"
              ...
              {currentStep < 4 ? (
                <button
                  type="button"
                  onClick={() => setCurrentStep(currentStep + 1)}
                  className="px-5 py-2.5 rounded-xl bg-[#B88736] hover:bg-[#B88736] text-white text-xs font-medium flex items-center gap-1.5 transition cursor-pointer shadow-lg shadow-indigo-600/10"
                >
                  <span>Avançar</span>
                  <ArrowRight size={14} />
                </button>
