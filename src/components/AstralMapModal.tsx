  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-[#2A2420]/30 backdrop-blur-md overflow-y-auto" id="astral-map-modal">
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#B88736]/15 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`p-2 rounded-xl text-xs font-mono transition cursor-pointer border ${
                activeTab === 'edit'
                  ? 'bg-purple-600/30 border-purple-500 text-[#5C5248]'
                  : 'bg-[#F5EFE4]/60 hover:bg-[#F5EFE4] text-[#5C5248] border-[#E5DAC6]'
              }`}
        ...
        <div className="p-2.5 bg-white/80 border border-[#E5DAC6] rounded-2xl flex flex-wrap items-center justify-between gap-2 text-xs font-mono shrink-0 my-3">
          <div className="flex items-center gap-3 text-[#5C5248] flex-wrap">
            ...
            {userProfile.birthCity && (
              <span className="flex items-center gap-1.5 text-[#2A2420]">
                <MapPin size={13} className="text-[#B88736]" /> {userProfile.birthCity}
              </span>
            )}
          </div>
          ...
          <button
            onClick={() => setActiveTab('edit')}
            className="text-[11px] text-purple-400 hover:text-[#B88736] underline font-sans flex items-center gap-1 cursor-pointer ml-auto"
          >
        ...
        <div className="flex gap-1.5 overflow-x-auto pb-1 scrollbar-none shrink-0 border-b border-[#E5DAC6] mb-3">
          ...
          >
            <Orbit size={13} className="text-[#B88736]" />
        ...
        <div ref={printRef} className="flex-1 overflow-y-auto space-y-4 pr-1">
          ...
          {activeTab === 'trinity' && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                {/* Sol */}
                <div className="p-4 rounded-2xl bg-gradient-to-b from-amber-950/30 to-[#F3EBDD] border border-amber-500/30 space-y-2 relative overflow-hidden">
                  ...
                  <p className="text-xs text-[#5C5248] leading-relaxed pt-1">
                    <strong>Virtude da Alma:</strong> {astral.sunSignVirtue}
                  </p>
                </div>

                {/* Ascendente */}
                <div className="p-4 rounded-2xl bg-gradient-to-b from-indigo-950/30 to-[#F3EBDD] border border-[#B88736]/30 space-y-2 relative overflow-hidden">
                  <div className="flex items-center justify-between">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-[#B88736]/10 border border-[#B88736]/20 text-[#B88736] inline-block mt-0.5">
                ...
                <div className="p-4 rounded-2xl bg-gradient-to-b from-purple-950/30 to-[#F3EBDD] border border-purple-500/30 space-y-2 relative overflow-hidden">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-purple-500/10 border border-purple-500/20 text-[#B88736] inline-block mt-0.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                ...
                <div className="p-4 rounded-2xl bg-white border border-[#E5DAC6] space-y-2.5">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-mono font-bold text-[#2A2420] uppercase flex items-center gap-1.5">
                      <Compass size={14} className="text-[#B88736]" /> Balanço dos 4 Elementos
                    </span>
                  ...
                  <div className="space-y-2 pt-1">
                    <div className="space-y-1">
                      <div className="flex justify-between text-[11px] font-mono">
                        ...
                        <span className="text-[#5C5248] font-bold">{astral.elementBalance.fire}%</span>
                      </div>
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-[11px] font-mono">
                        ...
                        <span className="text-[#5C5248] font-bold">{astral.elementBalance.earth}%</span>
                      </div>
                      <div className="h-1.5 bg-[#F5EFE4] rounded-full overflow-hidden">
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-[11px] font-mono">
                        ...
                        <span className="text-[#5C5248] font-bold">{astral.elementBalance.air}%</span>
                      </div>
                      <div className="h-1.5 bg-[#F5EFE4] rounded-full overflow-hidden">
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-[11px] font-mono">
                        <span className="text-[#B88736] flex items-center gap-1"><Droplets size={12} /> Água (Sensibilidade)</span>
                        <span className="text-[#5C5248] font-bold">{astral.elementBalance.water}%</span>
                      </div>
                      <div className="h-1.5 bg-[#F5EFE4] rounded-full overflow-hidden">
                        <div className="h-full bg-[#B88736]" style={{ width: `${astral.elementBalance.water}%` }} />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-gradient-to-br from-indigo-950/40 via-purple-950/20 to-[#F3EBDD] border border-[#B88736]/30 space-y-2 flex flex-col justify-between">
                  <div>
                    <span className="text-[10px] font-mono uppercase text-[#B88736] font-bold block mb-1">
                      Orientação do Terapeuta Éverton Piceni
                    </span>
                    <p className="text-xs text-[#2A2420] leading-relaxed italic">
                      "{astral.astralSpiritualGuidance}"
                    </p>
                  </div>

                  <div className="p-2.5 rounded-xl bg-white/80 border border-[#B88736]/20 mt-2">
          ...
          {activeTab === 'attitudes' && (
            <div className="space-y-4">
              ...
              {astral.soulMissionSummary && (
                <div className="p-4.5 rounded-2xl bg-gradient-to-r from-purple-950/40 via-indigo-950/40 to-[#F3EBDD] border border-purple-500/35 space-y-2">
                  <div className="flex items-center gap-2">
              ...
              {astral.practicalAttitudes && (
                <div className="space-y-3.5">
                  ...
                  <div className="p-4.5 rounded-2xl bg-[#2A2420]/30 border border-emerald-500/30 space-y-2.5">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="space-y-2">
                      {astral.practicalAttitudes.dailyPractices.map((practice, idx) => (
                        <div key={idx} className="p-2.5 rounded-xl bg-[#FBF8F2]/90 border border-[#E5DAC6] text-xs text-[#2A2420] flex items-start gap-2">
                  ...
                  <div className="p-4.5 rounded-2xl bg-[#2A2420]/30 border border-[#B88736]/30 space-y-2.5">
                    <div className="flex items-center gap-2">
                      <Shield size={16} className="text-[#B88736]" />
                      <h4 className="text-xs font-mono font-bold text-[#B88736] uppercase">
                        Transmutação da Sombra Cósmica & Cura Emocional
                      </h4>
                    </div>
                    <div className="space-y-2">
                      {astral.practicalAttitudes.shadowWork.map((shadow, idx) => (
                        <div key={idx} className="p-2.5 rounded-xl bg-[#FBF8F2]/90 border border-[#E5DAC6] text-xs text-[#5C5248] leading-relaxed">
                          {shadow}
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="p-4.5 rounded-2xl bg-[#2A2420]/30 border border-amber-500/30 space-y-2.5">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="p-4.5 rounded-2xl bg-gradient-to-r from-indigo-950/50 via-purple-950/40 to-[#F3EBDD] border border-[#B88736]/40 space-y-2">
                    <span className="text-[10px] font-mono uppercase tracking-widest text-[#B88736] font-bold flex items-center gap-1.5">
                      <Sparkles size={12} className="text-[#B88736]" /> Meditação Cósmica Personalizada
                    </span>
                    <p className="text-xs text-[#2A2420] italic font-serif leading-relaxed">
          ...
          {activeTab === 'therapy' && (
            <div className="space-y-4">
                ...
                <div className="p-4 rounded-2xl bg-white border border-[#E5DAC6] space-y-2.5">
                  ...
                  <div className="space-y-1.5">
                    {astral.suggestedCrystals?.map((c, i) => (
                      <div key={i} className="p-2 rounded-xl bg-[#FBF8F2] border border-[#E5DAC6] text-xs text-[#2A2420] flex items-center justify-between">
                        <span>{c}</span>
              ...
              <div className="p-4 rounded-2xl bg-gradient-to-r from-indigo-950/40 to-[#F3EBDD] border border-[#B88736]/30 space-y-1.5">
                <span className="text-xs font-mono font-bold text-[#B88736] uppercase flex items-center gap-1.5">
          ...
          {activeTab === 'edit' && (
            <form onSubmit={handleSaveBirthDetails} className="p-5 rounded-2xl bg-white border border-[#E5DAC6] space-y-4">
              <div className="space-y-1">
                <h4 className="text-xs font-mono font-bold text-[#2A2420] uppercase flex items-center gap-2">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-xl bg-[#B88736] hover:bg-[#B88736] text-white text-xs font-semibold flex items-center gap-1.5 transition cursor-pointer shadow-md shadow-indigo-600/20"
                >
                  <Save size={14} />
