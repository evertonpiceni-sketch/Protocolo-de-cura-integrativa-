...
export default function TransformationHome(props: Props) {
  ...
  if (!journeyEntered) {
    ...
    return <div className="mx-auto w-full max-w-[520px] px-4 py-4 sm:py-6">
      <section className="ep-home-hero relative w-full overflow-hidden rounded-[2rem] border border-[#B88736]/35 px-6 py-8 text-center shadow-[0_24px_70px_rgba(0,0,0,.34)]">
        ...
        <div className="ep-brand-signature-wrap relative mx-auto mb-7 flex h-28 w-28 items-center justify-center overflow-hidden rounded-full border border-[#B88736]/28 bg-[#041f17]/65"><img src={brandLogo} alt="Everton Piceni — Terapias Holísticas e Bem-Estar" className="ep-brand-signature h-full w-full object-cover" /></div>
  ...
  return <div className="ep-home mx-auto w-full max-w-[520px] px-4 pb-28 sm:px-5">
    <section className="ep-home-hero overflow-hidden rounded-[2rem] border border-[#B88736]/35 px-6 py-8 text-center shadow-[0_24px_70px_rgba(0,0,0,.34)]">
      <div className="ep-brand-signature-wrap mx-auto mb-6 flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border border-[#B88736]/24 bg-[#041f17]/60"><img src={brandLogo} alt="Everton Piceni — Terapias Holísticas e Bem-Estar" className="ep-brand-signature h-full w-full object-cover" /></div>
