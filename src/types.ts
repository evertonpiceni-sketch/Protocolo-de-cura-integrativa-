...
export const PROTOCOL_STAGES: StageContent[] = [
  ...
  },
  {
    ...
    text: "Após a grande limpeza, sinta a energia se suavizar, tornando-se pura doçura. O Reiki Raio Rosa inunda o seu chakra cardíaco. Sinta uma luz rosa-quartzo expandir do seu peito. Ela acolhe as experiências de abandono e rejeição, preenchendo o seu ser com autoaceitação, compaixão e amor por sua própria jornada. Permita que os espaços de vazio e solidão comecem a receber presença e acolhimento.\n\nConectamos agora com a Golden Light Source, a Fonte de Luz Dourada Primordial. Uma cascata de ouro líquido desce do topo da sua cabeça, iluminando cada átomo do seu corpo. Essa luz dourada se funde ao Raio de Ouro e Verde de São Rafael, envolvendo todo o seu ser em uma sensação profunda de equilíbrio, renovação e reconexão. Você é perfeito, você é um reflexo da Fonte.\n\nRespire novamente e segure por 5 segundos e sinta o amor entrando em você, os pensamentos desacelrando, a caragaem vindo, a estabilidade chegando, sinta essa energia de reconexão contigo. Solte bem devagar e deixe ir todos aqueles sentimentos que outrora você nutria. Você é especial.",
    durationSeconds: 60,
    colorTheme: {
